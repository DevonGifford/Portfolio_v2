    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col flex-wrap gap-1 font-titleFont text-xl font-medium sml:flex-row">
                ...
                <span className="mt-1 flex text-base font-medium text-textGreen">
                    @ Freelance
                </span>
            </div>
            ...
            <p className="mt-3 flex gap-2 text-base font-light text-textDark">
                <strong>
                    As a frontend-focused web developer specializing in
                    WordPress, Ive crafted responsive, user-friendly websites
                    through adept theme customization and plugin integration.
                    <br />
