    ...
    return (
        ...
        >
            ...
            <p className="mt-3 flex gap-2 text-base font-light text-textDark">
                <strong>
                    In my role supporting the growth of an art auction start-up,
                    I utilized HTML/CSS, JavaScript/jQuery, and a content
                    management system (CMS) to enhance the websites
